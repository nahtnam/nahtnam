...
![](/images/disable-spotlight-I5MT.png)

\- Then go back to Raycast and change the hotkey to `cmd` + `space`

![](/images/raycast-shortcut-MyNT.png)
...
![](/images/disable-auto-shuffle-MzMT.png)
